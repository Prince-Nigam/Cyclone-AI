...
const COLOR_MAP: Record<string, { bg: string; icon: string; tag: string; border: string }> = {
  blue:   { bg: "bg-blue-100   dark:bg-blue-500/10",   icon: "text-blue-600   dark:text-blue-400",   tag: "bg-blue-100   dark:bg-blue-500/15   text-blue-700   dark:text-blue-300",   border: "border-blue-200   dark:border-blue-500/20" },
  purple: { bg: "bg-purple-100 dark:bg-purple-500/10", icon: "text-purple-600 dark:text-purple-400", tag: "bg-purple-100 dark:bg-purple-500/15 text-purple-700 dark:text-purple-300", border: "border-purple-200 dark:border-purple-500/20" },
  orange: { bg: "bg-orange-100 dark:bg-orange-500/10", icon: "text-orange-600 dark:text-orange-400", tag: "bg-orange-100 dark:bg-orange-500/15 text-orange-700 dark:text-orange-300", border: "border-orange-200 dark:border-orange-500/20" },
  red:    { bg: "bg-red-100    dark:bg-red-500/10",    icon: "text-red-600    dark:text-red-400",    tag: "bg-red-100    dark:bg-red-500/15    text-red-700    dark:text-red-300",    border: "border-red-200    dark:border-red-500/20" },
  cyan:   { bg: "bg-cyan-100   dark:bg-cyan-500/10",   icon: "text-cyan-600   dark:text-cyan-400",   tag: "bg-cyan-100   dark:bg-cyan-500/15   text-cyan-700   dark:text-cyan-300",   border: "border-cyan-200   dark:border-cyan-500/20" },
  slate:  { bg: "bg-slate-100  dark:bg-slate-500/10",  icon: "text-slate-600  dark:text-slate-400",  tag: "bg-slate-100  dark:bg-slate-500/15  text-slate-700  dark:text-slate-300",  border: "border-slate-200  dark:border-slate-500/20" },
};
...
const STAT_COLOR: Record<string, string> = {
  blue:   "from-blue-50   to-white   dark:from-blue-500/20   dark:to-blue-600/5   border-blue-200   dark:border-blue-500/25   text-blue-600   dark:text-blue-400",
  green:  "from-green-50  to-white   dark:from-green-500/20  dark:to-green-600/5  border-green-200  dark:border-green-500/25  text-green-600  dark:text-green-400",
  purple: "from-purple-50 to-white   dark:from-purple-500/20 dark:to-purple-600/5 border-purple-200 dark:border-purple-500/25 text-purple-600 dark:text-purple-400",
  orange: "from-orange-50 to-white   dark:from-orange-500/20 dark:to-orange-600/5 border-orange-200 dark:border-orange-500/25 text-orange-600 dark:text-orange-400",
};
              ...
              <tbody className="divide-y divide-slate-100/50 dark:divide-slate-700/30">
                {recentCyclones.map((c) => (
                  <tr key={c.id} className="hover:bg-blue-50 dark:hover:bg-blue-500/10 transition-colors group">
                    ...
                    <td className="px-4 py-3 font-mono text-slate-600 dark:text-slate-300 text-xs">                      {c.peak_wind_kt ? `${c.peak_wind_kt} kt` : "—"}
                    </td>
                    <td className="px-4 py-3">
