      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-red-600 hover:bg-red-700 disabled:bg-slate-300 dark:disabled:bg-slate-700 text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2 shadow-sm shadow-red-500/20"
          >
            {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> Predicting...</> : <>⚠️ Run Prediction</>}
          </button>
              ...
              <div className="space-y-1 max-h-48 overflow-y-auto">
                {predictedTrack.map((pt) => (
                  <div key={pt.step} className="flex items-center justify-between text-xs py-1 border-b border-slate-50 dark:border-slate-700">
                    <span className="text-red-500 dark:text-red-400 font-medium font-mono">t+{pt.hours_ahead}h</span>
